  ...
  <div class="container-fluid">
    ...
    <div id="sidebar_navbar" class="collapse navbar-collapse text-center">
      ...
      <ul class="nav navbar-nav visible-xs">
        ...
        <li id="nav_my_classrooms_2">
          <a class="sidebar-menu" href="my_classrooms.php">
            <span class="fa fa-university"></span> My Classrooms
          </a>
        </li>

        <li id="nav_backpack_2">
          <a class="sidebar-menu" href="backpack.php">
            <span class="fa fa-briefcase"></span> Backpack
          </a>
        </li>
