...
if (
  ...
  if ($type === 'Student') {
    ...
    $command = 'SELECT a.title, a.date_time_created, a.date_time_published, a.due_date, a.due_time, a.version, a.file, (SELECT COUNT(*) FROM assignment_submissions AS asub WHERE asub.assignment_id = a.id AND asub.file IS NOT NULL AND asub.date_time_assigned IS NOT NULL), (SELECT COUNT(*) FROM assignment_submissions AS asub WHERE asub.assignment_id = a.id AND asub.file IS NULL AND asub.date_time_assigned IS NOT NULL) FROM assignments AS a WHERE id = ?';
