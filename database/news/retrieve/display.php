...
if (
  ...
  switch ($_GET['method']) {
    ...
    case 'newer':
      ...
      $command = 'SELECT n.id, n.image, n.title, n.caption, n.date_time_posted, u.id, u.username FROM news AS n LEFT JOIN users AS u ON n.admin_id = u.id WHERE n.id > ? ORDER BY n.id DESC LIMIT 3';
    ...
    case 'fresh':
      ...
      $command = 'SELECT n.id, n.image, n.title, n.caption, n.date_time_posted, u.id, u.username FROM news AS n LEFT JOIN users AS u ON n.admin_id = u.id ORDER BY n.id DESC LIMIT 3';
