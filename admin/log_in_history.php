...
<head>
  ...
  <title>iSchool | Log In History</title>
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            ...
            <div id="log_in_history_panel" class="panel-body">

              <div id="log_in_history_header" class="row">
                <div class="col-md-3">
                  <h4>Login Date</h4>
                </div>
  ...
  <script src="../js/log_in_history_manager.js"></script>
